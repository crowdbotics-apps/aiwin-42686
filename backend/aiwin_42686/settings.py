"""
Django settings for aiwin_42686 project.
...
WSGI_APPLICATION = 'aiwin_42686.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aiwin_42686 API",
    "DESCRIPTION": "API documentation for aiwin_42686 App",
    "VERSION": "v1",
}
